    ...
    <div >
      <div >
		...
		<tr>
			...
			<td class="col-md-6"><input type="password" class="form-control" name="txt_Password" required id="txt_Password" pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{6,}$" placeholder="Enter Password"></td>
			</tr>
			<tr>
			<td>&nbsp;</td>
			</tr>
			<tr>
			<td class="col-md-6" colspan="2" align="center" ><input type="submit" class="btn-primary" name="btn_Submit" id="btn_Submit" Value="Login" />| <a href="ForgetPassword.jsp" style=" font-size: 15px;color: red"  >ForgetPassword</a><br>
			</td>
			</tr>
			</table>
			</div>
