...
<div class="main">
  <div class="main_resize">
    <div class="header">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li><a href="AddComment.jsp">Add Twitter Post</a></li>
          <li class="active"><a href="ShowComment.jsp">My profile</a></li>
	...
	<td class="col-md-2"><h3>Email-ID</h3></td>
			<td class="col-md-2"><h3>Twitter Post</h3> </td>
			...
			Connection con = Dbconn.conn();
				...
				String qrry1 = "select * from testingdata where username='"+emailid+"'";
