      ...
      <div >
        <div >
          <div align="center">
            ...
            <form role="form" action="ForgetPassword" method="post">
	       ...
	       <tr>
			...
			<tr>
			<td class="col-md-6" colspan="2" align="center" ><input type="submit" class="btn-primary" name="btn_Submit" id="btn_Submit" value="Forget Password" /><br>
			</td>
			</tr>
			</table>
			</div>
